...
//		$content = "<p>We've recieved your order. Thank You for Shopping at Vinyl, Accessories and More!</p><p>Here is your download! <a href = '"+$product.digital_path+"' class = 'dlButton' download>Download</a></p>";
//	}
//}
//else {
//	$content = "<p>We've recieved your order. Thank You for Shopping at Vinyl, Accessories and More!</p>";
//}
?>
<!doctype html>
<html><head>
...
-->
<meta charset="utf-8">
<title>Viny, Accesories, and More!</title><script src = "master.js"></script>
<style>
	#main{
		text-align: center;
	}
...
<body>
	...
	<div id = "main" class = "container-fluid">
		...
		<h2>Here is your download - <a href = "storage/package.zip" class = "dlButton" download>Download</a></h2>
	</div>
	<!--FOOOTER-->
